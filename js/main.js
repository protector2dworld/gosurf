$(function(){
    ...
    $('.sleep__slider-item').each(function() {
      var slide = $(this)
      slide.find('.quantity-button').on('click', function(){   
              
        let summ = slide.find('.nights').val() * slide.find('.summ').data('nights') + (slide.find('.guests').val() -1) * slide.find('.summ').data('guests');

        slide.find('.summ').html('$' + summ);
